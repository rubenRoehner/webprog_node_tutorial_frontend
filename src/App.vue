...
export default {
  ...
  methods: {
    addEntry: function(e) {
      console.log(e)
      axios
        .post("https://webprog-node-tutorial.herokuapp.com/profs/", {
          name: e.name,
          rating: e.rating
        })
        .then(response => {
    ...
    editEntry: function(e) {
      axios
        .put("https://webprog-node-tutorial.herokuapp.com/profs/" + e.index, {
          name: e.name,
          rating: e.rating
        })
        .then(response => {
    ...
    removeEntry: function(e) {
      axios.delete("https://webprog-node-tutorial.herokuapp.com/profs/" + e.index).then(response => {
        this.listOfEntries = response.data;
      });
    }
  },
  mounted() {
    axios.get("https://webprog-node-tutorial.herokuapp.com/profs/").then(response => {
      this.listOfEntries = response.data;
    });
  }
};
